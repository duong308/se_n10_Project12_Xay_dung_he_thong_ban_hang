...
public class ChucNang {
	...
	public static void showErrorAlert(String contentText) {
	    ...
	    stage.getIcons().add(new Image("file:///C:/Users/Admin/eclipse-workspace/QuanLyBanHang_OOP_JavaFx/icon/wrong.png"));
	...
	public static void showWarningAlert(String contentText) {
	    ...
	    Stage stage = (Stage) alert.getDialogPane().getScene().getWindow();
	    stage.getIcons().add(new Image("file:///C:/Users/Admin/eclipse-workspace/QuanLyBanHang_OOP_JavaFx/icon/Warning.png"));
